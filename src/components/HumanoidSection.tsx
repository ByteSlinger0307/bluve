      ...
      <section className="w-full h-screen py-10 md:py-16 sticky top-0 overflow-hidden bg-white" id="why-humanoid">
        <div className="container px-6 lg:px-8 mx-auto h-full flex flex-col">
          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
            ...
            >
              <div
                className="absolute inset-0 z-0 bg-gradient-to-b from-primary/20 to-dark-900/80"
                style={{
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    We're giving water a new language of expression.
                  </h3>
                </div>
              </div>
            </div>
            ...
            >
              <div
                className="absolute inset-0 z-0 bg-gradient-to-b from-primary/30 to-dark-900/85"
                style={{
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    We're bringing design and purity to where elegance lives.
                  </h3>
                </div>
              </div>
            </div>
            ...
            >
              <div
                className="absolute inset-0 z-0 bg-gradient-to-b from-secondary/40 to-dark-900/90"
                style={{
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    We're crafting experiences, <span className="text-[#c8ad7f]">not commodities.</span>
                  </h3>
                </div>
              </div>
            </div>
